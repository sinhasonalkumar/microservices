...
public class RequestMatchingAuthenticationManagerResolver implements AuthenticationManagerResolver<HttpServletRequest> {
    ...
    private final Map<RequestMatcher, AuthenticationManager> authenticationManagers;
    ...
    public RequestMatchingAuthenticationManagerResolver(Map<RequestMatcher, AuthenticationManager> authenticationManagers) {
