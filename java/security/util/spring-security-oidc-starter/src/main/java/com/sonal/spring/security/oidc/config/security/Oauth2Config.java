...
public class Oauth2Config {
	...
	@Autowired
	private OIDCWebSecurityConfigurer oidcWebSecurityConfigurer;
	...
	public JwtDecoder jwtDecoder() {
		...
		validators.add(token -> {
			...
			expectedAudience.add(oidcWebSecurityConfigurer.getOauth2Audience());
	...
	public OpaqueTokenIntrospector opaqueTokenIntrospector() {
		...
		OpaqueTokenIntrospector introspectionClient = new NimbusOpaqueTokenIntrospector(oidcWebSecurityConfigurer.getIntrospectionUri(),
