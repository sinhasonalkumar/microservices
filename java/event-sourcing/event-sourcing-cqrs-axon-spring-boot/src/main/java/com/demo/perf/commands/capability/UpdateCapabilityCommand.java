...
public class UpdateCapabilityCommand extends BaseCommand<String> {
    ...
    public UpdateCapabilityCommand(String id, String name, String description,CapabilityType capabilityType) {
    	super(id);
